...
public class TestImpl2 implements IJSONObject {
...
//
    ...
    public TestImpl2 getT3() {
        return t3;
    }

    public void setT3(TestImpl2 t3) {
        this.t3 = t3;
    }

    public TestImpl2 getT4() {
        return t4;
    }

    public void setT4(TestImpl2 t4) {
        this.t4 = t4;
    }
    ...
    public HashMap<String, TestImpl2> getMap4() {
        return map4;
    }

    public void setMap4(HashMap<String, TestImpl2> map4) {
        this.map4 = map4;
    }
    ...
    public ArrayList<TestImpl2> getList3() {
        return list3;
    }

    public void setList3(ArrayList<TestImpl2> list3) {
        this.list3 = list3;
    }
...
//    public ArrayList<MainActivity> list2;
    public ArrayList<TestImpl2> list3;
...
//        }
    ...
    public void toJSONString(JSONStringer jsonStringer) {
        jsonStringer.object();
        jsonStringer.key("list5", 0);
        jsonStringer.writeToList(list5);
        jsonStringer.dot();
        jsonStringer.writeToObject("a",a);
        jsonStringer.dot();
        jsonStringer.writeToObject("b",b);
        jsonStringer.dot();
        jsonStringer.writeToObject("t2", t2);
